...
if st.session_state.current_page == "home":
    ...
    # 2. CSS MEGA-ROBUSTO: Transforma los botones en tarjetas animadas interactivas
    st.markdown(f"""
    <style>
    /* Diseño Base para los 4 botones (Anula el gradiente y aplica Neumorfismo) */
    div[data-testid="stColumn"] button, 
    div[data-testid="column"] button {{
        background: #FFFFFF !important;
        background-image: none !important; /* Fuerza a quitar el gradiente global */
        border-radius: 20px !important;
        ...
        /* Ajuste para las animaciones y textos */
    ...
    /* El título sube y cambia de color al pasar el ratón */
    ...
    /* Inyección de la Descripción debajo del título */
    div[data-testid="stColumn"] button::after, 
    ...
    div[data-testid="stColumn"] button:hover::after, 
    div[data-testid="column"] button:hover::after {{
        opacity: 1 !important;
        transform: translateY(0) !important;
    }}

    /* ========================================== */
    /* INYECCIÓN DE ANIMACIONES SVG POR POSICIÓN  */
    /* ========================================== */
    ...
    @media (max-width: 768px) {{
        div[data-testid="stColumn"] button, div[data-testid="column"] button {{ min-height: 200px !important; margin-bottom: 10px; }}
        div[data-testid="stColumn"] button::after, div[data-testid="column"] button::after {{ font-size: 12px !important; bottom: 10px !important; }}
    }}
    </style>
    """, unsafe_allow_html=True)

    # 3. Renderizado de Título Principal
    ...
    # 4. Los Botones Nativos de Streamlit (El CSS los convertirá en las tarjetas mágicas automáticamente)
    c1, c2 = st.columns(2)
    with c1:
