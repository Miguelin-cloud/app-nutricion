...
if st.session_state.current_page == "home":
    ...
    if lang_code == "Spanish":
        d_m1 = "Descubre recetas saludables usando ingredientes de tu despensa."
        d_m2 = "Gestiona tu inventario y extrae ingredientes con Inteligencia Artificial."
        d_m3 = "Planifica tu semana, ajusta macros y lleva el control de cada comida."
        d_m4 = "Evalúa tu salud con reportes clínicos generados por IA."
    elif lang_code == "French":
        d_m1 = "Découvrez des recettes magiques avec les ingrédients de votre cuisine."
        d_m2 = "Gérez votre inventaire et extrayez des ingrédients avec l'IA."
        d_m3 = "Planifiez votre semaine et surveillez vos macros pour chaque repas."
        d_m4 = "Évaluez votre santé avec des rapports cliniques IA."
    elif lang_code == "Italian":
        d_m1 = "Scopri ricette magiche con gli ingredienti della tua dispensa."
        d_m2 = "Gestisci il tuo inventario ed estrai ingredienti con l'IA."
        d_m3 = "Pianifica la tua settimana e controlla i macro di ogni pasto."
        d_m4 = "Valuta la tua salute con report clinici IA."
    else: 
        ...
        d_m4 = "Evaluate your health with detailed clinical reports by AI."

    # CSS REFORZADO: Ignora .stButton y ataca los elementos base de Streamlit
    st.markdown(f"""
    <style>
    /* 1. RESET Y NEUMORFISMO BASE (Forzamos a anular el botón global) */
    section.main div[data-testid="column"] button, 
    section.main div[data-testid="stColumn"] button {{
        background: #FDFBF7 !important; /* Forza el fondo blanco roto, eliminando el gradiente */
    ...
    /* 3. DESCRIPCIONES FLOTANTES INYECTADAS POR CSS */
    ...
    /* 4. ASIGNACIÓN DE ANIMACIONES EXACTAS POR POSICIÓN DE BOTÓN */
    
    /* MOD 1: COCINA (Columna 1, Botón 1) */
    ...
    /* MOD 2: COMPRA / STICKMAN (Columna 2, Botón 1) */
    ...
    /* MOD 4: SALUD / CORAZÓN (Columna 2, Botón 2) */
    ...
    @media (max-width: 768px) {{
        section.main div[data-testid="column"] button, section.main div[data-testid="stColumn"] button {{ 
            min-height: 200px !important; font-size: 20px !important; margin-bottom: 15px !important; 
        }}
        section.main div[data-testid="column"] button::after, section.main div[data-testid="stColumn"] button::after {{ 
            font-size: 12px !important; bottom: 10px !important; 
        }}
    }}
    </style>
    """, unsafe_allow_html=True)
